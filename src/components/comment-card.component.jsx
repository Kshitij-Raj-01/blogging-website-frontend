...
const CommentCard = ({ index, leftVal, commentData }) => {
    ...
    let { blog, blog : { comments, comments: { results: commentsArr },activity ,activity: { total_parent_comments } ,author: { personal_info: { username: blog_author } } }, setBlog, setTotalParentCommentsLoaded } = useContext(BlogContext)
            ...
            <div className="my-5 p-6 rounded-md border border-grey">
                ...
                <div className="flex gap-5 items-center mt-5">

                    {
                        ...
                        <button className="text-dark-grey p-2 px-3 hover:bg-grey/50 rounded-md flex items-center gap-2" onClick={hideReplies}>
                            <i className="fi fi-rs-comment-dots"></i>Hide Reply 
                        </button> :
                        <button className="text-dark-grey p-2 px-3 hover:bg-grey/50 rounded-md flex items-center gap-2" onClick={loadReplies}>

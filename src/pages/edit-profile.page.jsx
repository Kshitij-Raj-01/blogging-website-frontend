...
const EditProfile = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/update-profile", { username, bio, social_links: { youtube, facebook, instagram, twitter, github, website } }, {
            headers: {
                "Authorization":  `Bearer ${access_token}`
            }
        })
                ...
                <form ref={editProfileForm}>
                    ...
                    <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10">
                        ...
                        <div className="max-lg:center mb-5">
                            ...
                            <input type="file" id="uploadImg" accept="jpeg jpg png" hidden onChange={handleImagePreview} />
                        ...
                        <div className="w-full">
                            ...
                            <p className="my-6 text-dark-grey">Add you social handles below</p>
                            ...
                            <div className="md:grid md:grid-cols-2 gap-x-6">

                                {
                                    ...
                                    Object.keys(social_links).map((key, i) => {
                                        ...
                                        return <InputBox key={i} name={key} type="text" value={link} placeholder="https://" icon={(key != 'website' ? "fi-brands-" + key : "fi-rr-globe")}/>
                                    })

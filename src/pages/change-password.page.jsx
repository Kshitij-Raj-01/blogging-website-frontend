        ...
        <AnimationWrapper>
            ...
            <form ref={changePasswordForm}>
                ...
                <div className="py-10 w-full md:max-w-[400px]">
                    <InputBox name="currentPassword" type='password' className="profile-edit-input" placeholder="Current Passwrod" icon="fi-rr-unlock"/>
                    <InputBox name="newPassword" type='password' className="profile-edit-input" placeholder="New Passwrod" icon="fi-rr-unlock"/>
